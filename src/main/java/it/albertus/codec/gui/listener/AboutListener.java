...
public class AboutListener extends SelectionAdapter implements Listener {
	...
	public void widgetSelected(final SelectionEvent se) {
		...
		aboutDialog.setMessage(Messages.get("msg.application.name") + ' ' + Messages.get("msg.version", version.getNumber(), DateFormat.getDateInstance(DateFormat.MEDIUM).format(version.getDate())));
